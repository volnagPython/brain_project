...
############ Writing data into a json files ##################
base_dir = os.path.dirname(os.path.abspath(__file__))
print("Our root directory:", os.path.dirname(base_dir))

# Create the project's folders safely
os.makedirs('../../json', exist_ok = True)
os.makedirs('../../results', exist_ok = True)

file_path1 = os.path.join('../../json', "res_bs4_specs.json")
with open(file_path1, "w", encoding="utf-8") as f1:
    json.dump(dict_specs, f1, ensure_ascii = False, indent = 4)

file_path2 = os.path.join('../../json', "photo_bs4.json")
with open(file_path2, "w", encoding="utf-8") as f2:
    json.dump(photos, f2, ensure_ascii = False, indent = 4)
