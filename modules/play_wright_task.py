'''
Django project that runs a Playwright script to collect
the phone's specifications
and stores them in PostgreSQL through intermidiate .json file.
'''
import os,json
import time
...
def test_search_phone(page: Page):
    ...
    global phone_characteristics, road
...
################### Printing all characteristics in dictionary at once ####################
    try:
        ...
        if phone_characteristics != {}:
            ...
            road = BASE_DIR /"json"; #print(road)
            road.mkdir(parents = True, exist_ok=True)
            file_path = road / "res_data_plw.json"

            with open(file_path, "w", encoding="utf-8") as f:
                json.dump(phone_characteristics,
    ...
    print("Phone's specs stored in the json file in the directory: ", road)
    # Dec.11,2025
